...
try{
    ...
    response.meals.forEach(meal=>{
        ...
        recipeDiv.innerHTML=`
         ...
         <p><span><i>${meal.strCategory}</i></span></p> `
      ...
      recipeContainer.innerHTML="<h2>Try Searching Another Recipe</h2>";
} 
}
...
searchBtn.addEventListener("click",(event)=>{
    ...
    if(!searchInput){
        recipeContainer.innerHTML='<h2> Please ! Search for the meal</h2>';
        return;
    }
